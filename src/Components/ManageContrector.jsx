...
import { fetchContractors, } from './ApiThunk';
function ManageContrector() {
    const dispatch = useDispatch();
    const fetchClientData = useSelector((state) => state.api.contractors);
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:5000/ap1/v1/contractors', formData);
    ...
    const deleteData = async (id) => {
        try {
            const response = await axios.delete(`http://localhost:5000/ap1/v1/deletecontractor/${id}`);
    ...
    const exportToExcel = () => {
        ...
        const exportData = [
            ...
            ...api2Data.contractors.map((staffMember) => [
                staffMember.officer,
                staffMember.pin,
                staffMember.FirstN,
                staffMember.LastN,
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            if (showModal1 && currentStaffId) {
                const apiUrl = `http://localhost:5000/ap1/v1//getStaff1/${currentStaffId}`;
                try {
    ...
    const handleUpdate1 = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:5000/ap1/v1/newcontractors/${currentStaffId}`, { name, Short, email, phoneNo, payrate, address, status });
        ...
        <div>
                                    ...
                                    <div className="relative p-6 flex-auto">
                                        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                            <div className="mb-6">
                                                ...
                                                <input type="text" name="name" value={name} onChange={(e) => setname(e.target.value)} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter name" required />
                                            </div>
                                            <div className="mb-6">
                                                <label for="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Short Code</label>
                                                <input type="text" name="Short" value={Short} onChange={(e) => setShort(e.target.value)} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Code" required />
                                            </div>
                                        </div>
                                        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                            <div className="mb-6">
                                                <label for="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                                                <input type="text" name="email" value={email} onChange={(e) => setemail(e.target.value)} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Phone number" required />
                                            </div>
                                            <div className="mb-6">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                            <div className="mb-6">
                                                ...
                                                <input type="text" name="payrate" value={payrate} onChange={(e) => setpayrate(e.target.value)} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Phone number" required />
                                            </div>
                                            <div className="mb-6">
                                                <label for="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                                                <input type="text" name="address" value={address} onChange={(e) => setaddress(e.target.value)} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Your Address" required />
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <select id="countries" name='status' value={status} onChange={(e) => setstatus(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                ...
                                                <option value="Enterny">Entrny</option>
                                            </select>
                                        </div>
                                    </div>
                                    {/*footer*/}
            ...
            <div className="p-4 sm:ml-64">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-10">
                    <div>
                        <h1 className='text-2xl'>Manage Cotrectors
                        </h1>
                    </div>
                    <div>
                        <form>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="relative p-6 flex-auto">
                                            <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="mb-6">
                                                    <label for="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Short Code</label>
                                                    <input type="text" name="Short" value={formData.Short} onChange={handleInputChange} id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Code" required />
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                                <div className="mb-6">
                ...
                <div className="relative overflow-x-auto shadow-lg sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {fetchClientData && Array.isArray(fetchClientData.contractors) && fetchClientData.contractors.length > 0 ? (
                                fetchClientData.contractors.map((staffMember) => (
...
export default ManageContrector