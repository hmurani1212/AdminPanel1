...
import { fetchShift, } from './ApiThunk';
function Shift() {
    const dispatch = useDispatch();
    const fetchClientData = useSelector((state) => state.api.shift);
    useEffect(() => {
        dispatch(fetchShift())
    ...
    const exportToExcel = () => {
        ...
        const exportData = [
            ...
            ...api6data.staff.map((staffMember) => [
                staffMember.officer,
                staffMember.pin,
                staffMember.FirstN,
                staffMember.LastN,
        ...
        <div>
            ...
            <div className="p-4 sm:ml-64">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-10">
                    <div>
                        <h1 className='text-2xl'>Manage Shift
                        </h1>
                    </div>
                    <div>
                        <form>
                ...
                <div className="relative overflow-x-auto shadow-lg sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {fetchClientData && Array.isArray(fetchClientData.staff) && fetchClientData.staff.length > 0 ? (
                                fetchClientData.staff.map((staffMember) => (
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={staffMember._id}>
                                        ...
                                        <td className="flex items-center px-6 py-4">
                                            <i className="fa-solid fa-pen-to-square fa-xl cursor-pointer" onClick={handleUpdate}></i>
